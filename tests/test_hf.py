...
def test_msrc_endog_M():
    ...
    assert np.allclose(cov, np.array([
       [0.00089375, 0.00074381, 0.00073949, 0.00071962, 0.00068829],
       [0.00074381, 0.00082704, 0.00063961, 0.00061379, 0.00058625],
       [0.00073949, 0.00063961, 0.00066157, 0.00056948, 0.00052139],
       [0.00071962, 0.00061379, 0.00056948, 0.00066371, 0.00056229],
       [0.00068829, 0.00058625, 0.00052139, 0.00056229, 0.00062285]]))
...
def test_msrc_exog_M():
    ...
    # print(repr(cov))
    assert np.allclose(cov, np.array([
       [0.00059718, 0.00046716, 0.00048627, 0.00047739, 0.00048239],
       [0.00046716, 0.00049141, 0.00040886, 0.00041022, 0.00038586],
       [0.00048627, 0.00040886, 0.00051123, 0.00041091, 0.00036124],
       [0.00047739, 0.00041022, 0.00041091, 0.00052089, 0.0004096 ],
       [0.00048239, 0.00038586, 0.00036124, 0.0004096 , 0.00046266]]))
...
def test_msrc_pairwise_endog_M():
    ...
    # print(repr(cov))
    assert np.allclose(cov, np.array([
       [0.00066315, 0.0005628 , 0.00064991, 0.0005607 , 0.00063171],
       [0.0005628 , 0.00066562, 0.00055373, 0.00047332, 0.00058879],
       [0.00064991, 0.00055373, 0.00065447, 0.00053215, 0.00053332],
       [0.0005607 , 0.00047332, 0.00053215, 0.0005633 , 0.00054311],
       [0.00063171, 0.00058879, 0.00053332, 0.00054311, 0.00064149]]))
...
def test_msrc_pairwise_exog_M():
    ...
    # print(repr(cov))
    assert np.allclose(cov, np.array([
       [0.00055701, 0.00051552, 0.00059942, 0.00050699, 0.00058671],
       [0.00051552, 0.00054998, 0.00049925, 0.0004329 , 0.00055195],
       [0.00059942, 0.00049925, 0.00056433, 0.00049363, 0.00051724],
       [0.00050699, 0.0004329 , 0.00049363, 0.00048866, 0.00048158],
       [0.00058671, 0.00055195, 0.00051724, 0.00048158, 0.00057198]]))
